...
const plus5Button = document.querySelector(".plus5")
const minus5Button = document.querySelector(".minus5")
...
const coffeeShopCard = document.querySelector("#coffeeShopCard")
